...
```clojure
[com.appsflyer/donkey "0.5.2-SNAPSHOT"]
``` 

Including the library in `deps.edn`

```clojure
com.appsflyer/donkey {:mvn/version "0.5.2-SNAPSHOT"}
``` 
...
```clojure
:dependencies [com.appsflyer/donkey "0.5.2-SNAPSHOT" :exclusions [io.dropwizard.metrics/metrics-core]]
```   
