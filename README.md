...
```clojure
[com.appsflyer/donkey "0.2.0-SNAPSHOT"]
``` 

Including the library in `deps.edn`

```clojure
com.appsflyer/donkey {:mvn/version "0.2.0-SNAPSHOT"}
``` 
...
```clojure
:dependencies [com.appsflyer/donkey "0.2.0-SNAPSHOT" :exclusions [io.dropwizard.metrics/metrics-core]]
```   
