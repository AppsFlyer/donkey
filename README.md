...
```clojure
[com.appsflyer/donkey "0.1.1-SNAPSHOT"]
``` 

Including the library in `deps.edn`

```clojure
com.appsflyer/donkey {:mvn/version "0.1.1-SNAPSHOT"}
``` 
...
```clojure
:dependencies [com.appsflyer/donkey "0.1.1-SNAPSHOT" :exclusions [io.dropwizard.metrics/metrics-core]]
```   
