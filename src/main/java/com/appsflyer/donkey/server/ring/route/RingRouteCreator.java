...
public final class RingRouteCreator extends AbstractRouteCreator {
  
  public static AbstractRouteCreator create(Router router, RouteList routeList) {
    return new RingRouteCreator(router, routeList);
  }
  
  private final AdapterFactory adapterFactory;
  
  private RingRouteCreator(Router router, RouteList routeList) {
    super(router, routeList);
    adapterFactory = RingAdapterFactory.create();
  }
