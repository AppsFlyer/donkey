...
class RingClientTest {
  ...
  private static final Map<String, String> headers = Map.of(
      ...
      "Cookie", "_octo=GH1.2.3.4; _device_id=f901234; user_session=abcdefg; __Host-user_session_same_site=fdcba; logged_in=yes; dotcom_user=foobar; tz=Asia%2FHeaven; _gh_sess=foo.bar",
      "DNT", "1",
